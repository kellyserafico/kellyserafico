		...
		<>
			<section className="info-section" id="about">
				...
				<section className="moon">
					...
					<img src="/images/cloud/mooncloud1.svg" id="cloud1" alt="Cloud 1" />
					<img src="/images/cloud/mooncloud2.svg" id="cloud2" alt="Cloud 2" />
					<img src="/images/cloud/mooncloud3.svg" id="cloud3" alt="Cloud 3" />
